...
type UserForm struct {
	...
	Substitutes []UserSubstituteForm `json:"substitutes" binding:"omitempty"`
}

// UserSubstituteForm penanggung jawab/pendamping user (konsumen)
type UserSubstituteForm struct {
	RIC       string `json:"ric"`
